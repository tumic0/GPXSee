...
void Style::defaultPolygonStyle()
{
	...
	// NT types
	_polygons[0x10800] = _polygons.value(TYPE(0x01));
	_polygons[0x10801] = _polygons.value(TYPE(0x02));
	_polygons[0x10802] = _polygons.value(TYPE(0x03));
	_polygons[0x10901] = _polygons.value(TYPE(0x04));
	_polygons[0x10902] = _polygons.value(TYPE(0x05));
	_polygons[0x10903] = _polygons.value(TYPE(0x06));
	_polygons[0x10904] = _polygons.value(TYPE(0x07));
	_polygons[0x10905] = _polygons.value(TYPE(0x08));
	_polygons[0x10906] = _polygons.value(TYPE(0x09));
	_polygons[0x10907] = _polygons.value(TYPE(0x0a));
	_polygons[0x10908] = _polygons.value(TYPE(0x0b));
	_polygons[0x10909] = _polygons.value(TYPE(0x0c));
	_polygons[0x1090a] = _polygons.value(TYPE(0x0d));
	_polygons[0x1090b] = _polygons.value(TYPE(0x0e));
	_polygons[0x10900] = _polygons.value(TYPE(0x13));
	_polygons[0x10a01] = _polygons.value(TYPE(0x14));
	_polygons[0x10a02] = _polygons.value(TYPE(0x15));
	_polygons[0x10a03] = _polygons.value(TYPE(0x16));
	_polygons[0x10a04] = _polygons.value(TYPE(0x17));
	_polygons[0x1090c] = _polygons.value(TYPE(0x18));
	_polygons[0x1090d] = _polygons.value(TYPE(0x19));
	_polygons[0x1090e] = _polygons.value(TYPE(0x1a));
	_polygons[0x10a05] = _polygons.value(TYPE(0x1e));
	_polygons[0x10a06] = _polygons.value(TYPE(0x1f));
	_polygons[0x10b01] = _polygons.value(TYPE(0x28));
	_polygons[0x10b02] = _polygons.value(TYPE(0x32));
	_polygons[0x10b03] = _polygons.value(TYPE(0x3c));
	_polygons[0x10b04] = _polygons.value(TYPE(0x3d));
	_polygons[0x10b05] = _polygons.value(TYPE(0x3e));
	_polygons[0x10b06] = _polygons.value(TYPE(0x3f));
	_polygons[0x10b07] = _polygons.value(TYPE(0x40));
	_polygons[0x10b08] = _polygons.value(TYPE(0x41));
	_polygons[0x10b09] = _polygons.value(TYPE(0x42));
	_polygons[0x10b0a] = _polygons.value(TYPE(0x43));
	_polygons[0x10b0b] = _polygons.value(TYPE(0x44));
	_polygons[0x10b0c] = _polygons.value(TYPE(0x46));
	_polygons[0x10b0d] = _polygons.value(TYPE(0x47));
	_polygons[0x10b0e] = _polygons.value(TYPE(0x48));
	_polygons[0x10b0f] = _polygons.value(TYPE(0x49));
	_polygons[0x10d01] = _polygons.value(TYPE(0x4b));
	_polygons[0x10b10] = _polygons.value(TYPE(0x4c));
	_polygons[0x10c00] = _polygons.value(TYPE(0x4d));
	_polygons[0x10c01] = _polygons.value(TYPE(0x4e));
	_polygons[0x10c02] = _polygons.value(TYPE(0x4f));
	_polygons[0x10c03] = _polygons.value(TYPE(0x50));
	_polygons[0x10c04] = _polygons.value(TYPE(0x51));
	_polygons[0x10c05] = _polygons.value(TYPE(0x52));
...
void Style::defaultLineStyle(qreal ratio)
{
	...
	// NT types
	_lines[0x10801] = _lines.value(TYPE(0x02));
	_lines[0x10802] = _lines.value(TYPE(0x03));
	_lines[0x10803] = _lines.value(TYPE(0x04));
	_lines[0x10804] = _lines.value(TYPE(0x05));
	_lines[0x10900] = _lines.value(TYPE(0x20));
	_lines[0x10901] = _lines.value(TYPE(0x21));
	_lines[0x10902] = _lines.value(TYPE(0x22));
	_lines[0x10903] = _lines.value(TYPE(0x23));
	_lines[0x10904] = _lines.value(TYPE(0x24));
	_lines[0x10905] = _lines.value(TYPE(0x25));
	_lines[0x10a00] = _lines.value(TYPE(0x18));
	_lines[0x10a01] = _lines.value(TYPE(0x1f));
	_lines[0x10a02] = _lines.value(TYPE(0x26));
	_lines[0x10b02] = _lines.value(TYPE(0x1c));
	_lines[0x10b04] = _lines.value(TYPE(0x1e));
	_lines[0x10c00] = _lines.value(TYPE(0x14));
	_lines[0x10c02] = _lines.value(TYPE(0x27));
	_lines[0x10c03] = _lines.value(TYPE(0x28));
	_lines[0x10c04] = _lines.value(TYPE(0x29));
...
void Style::defaultPointStyle(qreal ratio)
{
	...
	// NT types
	_points[0x11401] = _points.value(TYPE(0x01));
	_points[0x11402] = _points.value(TYPE(0x02));
	_points[0x11403] = _points.value(TYPE(0x03));
	_points[0x10b00] = _points.value(0x2a00);
	_points[0x10b01] = _points.value(0x2a01);
	_points[0x10b02] = _points.value(0x2a02);
	_points[0x10b03] = _points.value(0x2a03);
	_points[0x10b04] = _points.value(0x2a04);
	_points[0x10b05] = _points.value(0x2a05);
	_points[0x10b06] = _points.value(0x2a06);
	_points[0x10b07] = _points.value(0x2a07);
	_points[0x10b08] = _points.value(0x2a08);
	_points[0x10b09] = _points.value(0x2a09);
	_points[0x10b0a] = _points.value(0x2a0a);
	_points[0x10b0b] = _points.value(0x2a0b);
	_points[0x10b0c] = _points.value(0x2a0c);
	_points[0x10b0d] = _points.value(0x2a0d);
	_points[0x10b0e] = _points.value(0x2a0e);
	_points[0x10b0f] = _points.value(0x2a0f);
	_points[0x10b10] = _points.value(0x2a10);
	_points[0x10b11] = _points.value(0x2a11);
	_points[0x10c01] = _points.value(0x2b01);
	_points[0x10c02] = _points.value(0x2b02);
	_points[0x10c03] = _points.value(0x2b03);
	_points[0x10c04] = _points.value(0x2b04);
	_points[0x10c05] = _points.value(0x2b05);
	_points[0x10d01] = _points.value(0x2c01);
	_points[0x10d02] = _points.value(0x2c02);
	_points[0x10d03] = _points.value(0x2c03);
	_points[0x10d04] = _points.value(0x2c04);
	_points[0x10d05] = _points.value(0x2c05);
	_points[0x10d06] = _points.value(0x2c06);
	_points[0x10d07] = _points.value(0x2c07);
	_points[0x10d08] = _points.value(0x2c08);
	_points[0x10d0a] = _points.value(0x2c0a);
	_points[0x10d0b] = _points.value(0x2c0b);
	_points[0x10d0c] = _points.value(0x2c0c);
	_points[0x10d0d] = _points.value(0x2c0d);
	_points[0x10d0e] = _points.value(0x2c0e);
	_points[0x10d10] = _points.value(0x2c10);
	_points[0x10e01] = _points.value(0x2d01);
	_points[0x10e02] = _points.value(0x2d02);
	_points[0x10e03] = _points.value(0x2d03);
	_points[0x10e04] = _points.value(0x2d04);
	_points[0x10e05] = _points.value(0x2d05);
	_points[0x10e06] = _points.value(0x2d06);
	_points[0x10e07] = _points.value(0x2d07);
	_points[0x10e08] = _points.value(0x2d08);
	_points[0x10e09] = _points.value(0x2d09);
	_points[0x10e0a] = _points.value(0x2d0a);
	_points[0x10e0b] = _points.value(0x2d0b);
	_points[0x10f02] = _points.value(0x2e02);
	_points[0x10f03] = _points.value(0x2e03);
	_points[0x10f05] = _points.value(0x2e05);
	_points[0x10f06] = _points.value(0x2e06);
	_points[0x10f07] = _points.value(0x2e07);
	_points[0x10f08] = _points.value(0x2e08);
	_points[0x10f09] = _points.value(0x2e09);
	_points[0x10f0a] = _points.value(0x2e0a);
	_points[0x10f13] = _points.value(0x2e13);
	_points[0x11001] = _points.value(0x2f01);
	_points[0x11002] = _points.value(0x2f02);
	_points[0x11003] = _points.value(0x2f03);
	_points[0x11004] = _points.value(0x2f04);
	_points[0x11005] = _points.value(0x2f05);
	_points[0x11006] = _points.value(0x2f06);
	_points[0x11007] = _points.value(0x2f07);
	_points[0x11008] = _points.value(0x2f08);
	_points[0x11009] = _points.value(0x2f09);
	_points[0x1100b] = _points.value(0x2f0b);
	_points[0x1100c] = _points.value(0x2f0c);
	_points[0x11010] = _points.value(0x2f10);
	_points[0x11012] = _points.value(0x2f12);
	_points[0x11013] = _points.value(0x2f13);
	_points[0x11017] = _points.value(0x2f17);
	_points[0x11101] = _points.value(0x3001);
	_points[0x11102] = _points.value(0x3002);
	_points[0x11103] = _points.value(0x3003);
	_points[0x11106] = _points.value(0x3006);
	_points[0x11107] = _points.value(0x3007);
	_points[0x11108] = _points.value(0x3008);
...
const Style::Line &Style::line(quint32 type) const
{
	...
	QHash<quint32, Line>::const_iterator it(_lines.find(type));
...
const Style::Polygon &Style::polygon(quint32 type) const
{
	...
	QHash<quint32, Polygon>::const_iterator it(_polygons.find(type));
...
const Style::Point &Style::point(quint32 type) const
{
	...
	QHash<quint32, Point>::const_iterator it(_points.find(type));
