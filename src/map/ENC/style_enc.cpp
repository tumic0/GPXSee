...
void Style::polygonStyle()
{
	...
	_polygons[SUBTYPE(SLCONS, 16)] = Polygon(Qt::NoBrush, QPen(QColor(0, 0, 0),
	  2, Qt::DashLine));
	_polygons[TYPE(I_SLCONS)] = _polygons.value(TYPE(SLCONS));
	_polygons[SUBTYPE(I_SLCONS, 1)] = _polygons.value(SUBTYPE(SLCONS, 1));
	_polygons[SUBTYPE(I_SLCONS, 2)] = _polygons.value(SUBTYPE(SLCONS, 2));
	_polygons[SUBTYPE(I_SLCONS, 3)] = _polygons.value(SUBTYPE(SLCONS, 3));
	_polygons[SUBTYPE(I_SLCONS, 4)] = _polygons.value(SUBTYPE(SLCONS, 4));
	_polygons[SUBTYPE(I_SLCONS, 5)] = _polygons.value(SUBTYPE(SLCONS, 5));
	_polygons[SUBTYPE(I_SLCONS, 6)] = _polygons.value(SUBTYPE(SLCONS, 6));
	_polygons[SUBTYPE(I_SLCONS, 7)] = _polygons.value(SUBTYPE(SLCONS, 7));
	_polygons[SUBTYPE(I_SLCONS, 8)] = _polygons.value(SUBTYPE(SLCONS, 8));
	_polygons[SUBTYPE(I_SLCONS, 9)] = _polygons.value(SUBTYPE(SLCONS, 9));
	_polygons[SUBTYPE(I_SLCONS, 10)] = _polygons.value(SUBTYPE(SLCONS, 10));
	_polygons[SUBTYPE(I_SLCONS, 11)] = _polygons.value(SUBTYPE(SLCONS, 11));
	_polygons[SUBTYPE(I_SLCONS, 12)] = _polygons.value(SUBTYPE(SLCONS, 12));
	_polygons[SUBTYPE(I_SLCONS, 13)] = _polygons.value(SUBTYPE(SLCONS, 13));
	_polygons[SUBTYPE(I_SLCONS, 14)] = _polygons.value(SUBTYPE(SLCONS, 14));
	_polygons[SUBTYPE(I_SLCONS, 15)] = _polygons.value(SUBTYPE(SLCONS, 15));
	_polygons[SUBTYPE(I_SLCONS, 16)] = _polygons.value(SUBTYPE(SLCONS, 16));
	...
	_polygons[SUBTYPE(I_RESARE, 1)] = _polygons.value(SUBTYPE(RESARE, 1));
	_polygons[SUBTYPE(I_RESARE, 2)] = _polygons.value(SUBTYPE(RESARE, 2));
	_polygons[SUBTYPE(I_RESARE, 3)] = _polygons.value(SUBTYPE(RESARE, 3));
	_polygons[SUBTYPE(I_RESARE, 4)] = _polygons.value(SUBTYPE(RESARE, 4));
	_polygons[SUBTYPE(I_RESARE, 5)] = _polygons.value(SUBTYPE(RESARE, 5));
	_polygons[SUBTYPE(I_RESARE, 6)] = _polygons.value(SUBTYPE(RESARE, 6));
	_polygons[SUBTYPE(I_RESARE, 7)] = _polygons.value(SUBTYPE(RESARE, 7));
	_polygons[SUBTYPE(I_RESARE, 8)] = _polygons.value(SUBTYPE(RESARE, 8));
	_polygons[SUBTYPE(I_RESARE, 9)] = _polygons.value(SUBTYPE(RESARE, 9));
	_polygons[SUBTYPE(I_RESARE, 12)] = _polygons.value(SUBTYPE(RESARE, 12));
	_polygons[SUBTYPE(I_RESARE, 14)] = _polygons.value(SUBTYPE(RESARE, 14));
	_polygons[SUBTYPE(I_RESARE, 17)] = _polygons.value(SUBTYPE(RESARE, 17));
	_polygons[SUBTYPE(I_RESARE, 22)] = _polygons.value(SUBTYPE(RESARE, 22));
	_polygons[SUBTYPE(I_RESARE, 23)] = _polygons.value(SUBTYPE(RESARE, 23));
	_polygons[SUBTYPE(I_RESARE, 25)] = _polygons.value(SUBTYPE(RESARE, 25));
	_polygons[SUBTYPE(I_RESARE, 26)] = _polygons.value(SUBTYPE(RESARE, 26));
	_polygons[SUBTYPE(ACHARE, 1)] = Polygon(QImage(":/marine/anchor-line.png"));
	_polygons[SUBTYPE(ACHARE, 2)] = _polygons.value(SUBTYPE(ACHARE, 1));
	_polygons[SUBTYPE(ACHARE, 3)] = _polygons.value(SUBTYPE(ACHARE, 1));
	_polygons[SUBTYPE(ACHARE, 4)] = _polygons.value(SUBTYPE(ACHARE, 1));
	_polygons[SUBTYPE(ACHARE, 5)] = _polygons.value(SUBTYPE(ACHARE, 1));
	_polygons[SUBTYPE(ACHARE, 6)] = _polygons.value(SUBTYPE(ACHARE, 1));
	_polygons[SUBTYPE(ACHARE, 7)] = _polygons.value(SUBTYPE(ACHARE, 1));
	_polygons[SUBTYPE(ACHARE, 8)] = Polygon(Qt::NoBrush,
	  QPen(QColor(0xeb, 0x49, 0xeb), 1, Qt::DashLine));
	_polygons[SUBTYPE(ACHARE, 9)] = _polygons.value(SUBTYPE(ACHARE, 1));
	_polygons[SUBTYPE(I_ACHARE, 1)] = _polygons.value(SUBTYPE(ACHARE, 1));
	_polygons[SUBTYPE(I_ACHARE, 2)] = _polygons.value(SUBTYPE(ACHARE, 2));
	_polygons[SUBTYPE(I_ACHARE, 3)] = _polygons.value(SUBTYPE(ACHARE, 3));
	_polygons[SUBTYPE(I_ACHARE, 4)] = _polygons.value(SUBTYPE(ACHARE, 4));
	_polygons[SUBTYPE(I_ACHARE, 5)] = _polygons.value(SUBTYPE(ACHARE, 5));
	_polygons[SUBTYPE(I_ACHARE, 6)] = _polygons.value(SUBTYPE(ACHARE, 6));
	_polygons[SUBTYPE(I_ACHARE, 7)] = _polygons.value(SUBTYPE(ACHARE, 7));
	_polygons[SUBTYPE(I_ACHARE, 8)] = _polygons.value(SUBTYPE(ACHARE, 8));
	_polygons[SUBTYPE(I_ACHARE, 9)] = _polygons.value(SUBTYPE(ACHARE, 9));
	_polygons[SUBTYPE(I_ACHARE, 10)] = _polygons.value(SUBTYPE(I_ACHARE, 1));
	_polygons[SUBTYPE(I_ACHARE, 11)] = _polygons.value(SUBTYPE(I_ACHARE, 1));
	_polygons[SUBTYPE(I_ACHARE, 12)] = _polygons.value(SUBTYPE(I_ACHARE, 1));
	...
	_polygons[TYPE(BERTHS)] = Polygon(Qt::NoBrush, QPen(QColor(0xeb, 0x49, 0xeb),
	  1, Qt::DashLine));
	_polygons[TYPE(I_BERTHS)] = _polygons.value(TYPE(BERTHS));
	_polygons[SUBTYPE(I_BERTHS, 6)] = _polygons.value(TYPE(BERTHS));
...
void Style::lineStyle(qreal ratio)
{
	...
	_lines[TYPE(I_SLCONS)] = _lines.value(TYPE(SLCONS));
	_lines[SUBTYPE(I_SLCONS, 1)] = _lines.value(SUBTYPE(SLCONS, 1));
	_lines[SUBTYPE(I_SLCONS, 2)] = _lines.value(SUBTYPE(SLCONS, 2));
	_lines[SUBTYPE(I_SLCONS, 3)] = _lines.value(SUBTYPE(SLCONS, 3));
	_lines[SUBTYPE(I_SLCONS, 4)] = _lines.value(SUBTYPE(SLCONS, 4));
	_lines[SUBTYPE(I_SLCONS, 5)] = _lines.value(SUBTYPE(SLCONS, 5));
	_lines[SUBTYPE(I_SLCONS, 6)] = _lines.value(SUBTYPE(SLCONS, 6));
	_lines[SUBTYPE(I_SLCONS, 7)] = _lines.value(SUBTYPE(SLCONS, 7));
	_lines[SUBTYPE(I_SLCONS, 10)] = _lines.value(SUBTYPE(SLCONS, 10));
	_lines[SUBTYPE(I_SLCONS, 11)] = _lines.value(SUBTYPE(SLCONS, 11));
	_lines[SUBTYPE(I_SLCONS, 12)] = _lines.value(SUBTYPE(SLCONS, 12));
	_lines[SUBTYPE(I_SLCONS, 13)] = _lines.value(SUBTYPE(SLCONS, 13));
	_lines[SUBTYPE(I_SLCONS, 15)] = _lines.value(SUBTYPE(SLCONS, 15));
...
void Style::pointStyle(qreal ratio)
{
	...
	_points[TYPE(I_ACHBRT)] = _points.value(TYPE(ACHBRT));
	...
	_points[SUBTYPE(I_DISMAR, 3)] = _points.value(SUBTYPE(I_DISMAR, 2));
	_points[SUBTYPE(I_DISMAR, 4)] = _points.value(SUBTYPE(I_DISMAR, 2));
	...
	_points[SUBTYPE(I_ACHARE, 1)] = _points.value(SUBTYPE(ACHARE, 1));
	_points[SUBTYPE(I_ACHARE, 2)] = _points.value(SUBTYPE(ACHARE, 2));
	_points[SUBTYPE(I_ACHARE, 3)] = _points.value(SUBTYPE(ACHARE, 3));
	_points[SUBTYPE(I_ACHARE, 4)] = _points.value(SUBTYPE(ACHARE, 4));
	_points[SUBTYPE(I_ACHARE, 5)] = _points.value(SUBTYPE(ACHARE, 5));
	_points[SUBTYPE(I_ACHARE, 6)] = _points.value(SUBTYPE(ACHARE, 6));
	_points[SUBTYPE(I_ACHARE, 7)] = _points.value(SUBTYPE(ACHARE, 7));
	_points[SUBTYPE(I_ACHARE, 8)] = _points.value(SUBTYPE(ACHARE, 8));
	_points[SUBTYPE(I_ACHARE, 9)] = _points.value(SUBTYPE(ACHARE, 9));
	_points[SUBTYPE(I_ACHARE, 10)] = _points.value(SUBTYPE(I_ACHARE, 1));
	_points[SUBTYPE(I_ACHARE, 11)] = _points.value(SUBTYPE(I_ACHARE, 1));
	_points[SUBTYPE(I_ACHARE, 12)] = _points.value(SUBTYPE(I_ACHARE, 1));
	_points[SUBTYPE(RESARE, 1)].setTextColor(QColor(0xeb, 0x49, 0xeb));
	_points[SUBTYPE(RESARE, 1)].setHaloColor(QColor());
	_points[SUBTYPE(RESARE, 2)] = _points.value(SUBTYPE(RESARE, 1));
	_points[SUBTYPE(RESARE, 4)].setTextColor(QColor(0x30, 0xa0, 0x1b));
	_points[SUBTYPE(RESARE, 4)].setHaloColor(QColor());
	_points[SUBTYPE(RESARE, 5)] = _points.value(SUBTYPE(RESARE, 4));
	_points[SUBTYPE(RESARE, 6)] = _points.value(SUBTYPE(RESARE, 4));
	_points[SUBTYPE(RESARE, 7)] = _points.value(SUBTYPE(RESARE, 4));
	_points[SUBTYPE(RESARE, 8)] = _points.value(SUBTYPE(RESARE, 1));
	_points[SUBTYPE(RESARE, 9)] = _points.value(SUBTYPE(RESARE, 1));
	_points[SUBTYPE(RESARE, 12)] = _points.value(SUBTYPE(RESARE, 1));
	_points[SUBTYPE(RESARE, 14)] = _points.value(SUBTYPE(RESARE, 1));
	_points[SUBTYPE(RESARE, 17)] = _points.value(SUBTYPE(RESARE, 1));
	_points[SUBTYPE(RESARE, 22)] = _points.value(SUBTYPE(RESARE, 4));
	_points[SUBTYPE(RESARE, 23)] = _points.value(SUBTYPE(RESARE, 4));
	_points[SUBTYPE(RESARE, 25)] = _points.value(SUBTYPE(RESARE, 1));
	_points[SUBTYPE(RESARE, 26)] = _points.value(SUBTYPE(RESARE, 1));
	_points[SUBTYPE(I_RESARE, 1)] = _points.value(SUBTYPE(RESARE, 1));
	_points[SUBTYPE(I_RESARE, 2)] = _points.value(SUBTYPE(RESARE, 2));
	_points[SUBTYPE(I_RESARE, 4)] = _points.value(SUBTYPE(RESARE, 4));
	_points[SUBTYPE(I_RESARE, 5)] = _points.value(SUBTYPE(RESARE, 5));
	_points[SUBTYPE(I_RESARE, 6)] = _points.value(SUBTYPE(RESARE, 6));
	_points[SUBTYPE(I_RESARE, 7)] = _points.value(SUBTYPE(RESARE, 7));
	_points[SUBTYPE(I_RESARE, 8)] = _points.value(SUBTYPE(RESARE, 8));
	_points[SUBTYPE(I_RESARE, 9)] = _points.value(SUBTYPE(RESARE, 9));
	_points[SUBTYPE(I_RESARE, 12)] = _points.value(SUBTYPE(RESARE, 12));
	_points[SUBTYPE(I_RESARE, 14)] = _points.value(SUBTYPE(RESARE, 14));
	_points[SUBTYPE(I_RESARE, 17)] = _points.value(SUBTYPE(RESARE, 17));
	_points[SUBTYPE(I_RESARE, 22)] = _points.value(SUBTYPE(RESARE, 22));
	_points[SUBTYPE(I_RESARE, 23)] = _points.value(SUBTYPE(RESARE, 23));
	_points[SUBTYPE(I_RESARE, 25)] = _points.value(SUBTYPE(RESARE, 25));
	_points[SUBTYPE(I_RESARE, 26)] = _points.value(SUBTYPE(RESARE, 26));
	_points[TYPE(DMPGRD)].setTextColor(QColor(0x5d, 0x5b, 0x59));
	_points[TYPE(DMPGRD)].setHaloColor(QColor());
	_points[SUBTYPE(DMPGRD, 1)] = _points.value(TYPE(DMPGRD));
	_points[SUBTYPE(DMPGRD, 2)] = _points.value(TYPE(DMPGRD));
	_points[SUBTYPE(DMPGRD, 3)] = _points.value(TYPE(DMPGRD));
	_points[SUBTYPE(DMPGRD, 4)].setTextColor(QColor(0xff, 0x40, 0x40));
	_points[SUBTYPE(DMPGRD, 4)].setHaloColor(QColor());
	_points[SUBTYPE(DMPGRD, 5)] = _points.value(TYPE(DMPGRD));
	_points[SUBTYPE(DMPGRD, 6)] = _points.value(TYPE(DMPGRD));
	...
	_points[SUBTYPE(BUISGL, 2)] = Point(svg2img(":/POI/harbor-11.svg", ratio),
	  Small);
	_points[SUBTYPE(BUISGL, 3)] = Point(QImage(":/marine/custom-office.png"),
	  Small);
...
const Style::Line &Style::line(uint type) const
{
	...
	QHash<uint, Line>::const_iterator it(_lines.find(type));
...
const Style::Polygon &Style::polygon(uint type) const
{
	...
	QHash<uint, Polygon>::const_iterator it(_polygons.find(type));
...
const Style::Point &Style::point(uint type) const
{
	...
	QHash<uint, Point>::const_iterator it(_points.find(type));
